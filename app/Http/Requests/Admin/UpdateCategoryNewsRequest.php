...
class UpdateCategoryNewsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
           ...
           'cat_code' => 'nullable|string|max:150|unique:news_category,cat_code,' . $this->route('categorynews') . ',cat_id',
            ...
            'cat_name' => 'nullable|string|max:250',
            'description' => 'nullable|string',
            'friendly_url' => 'nullable|string|max:250',
